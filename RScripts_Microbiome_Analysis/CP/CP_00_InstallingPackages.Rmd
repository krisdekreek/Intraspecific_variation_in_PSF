...
```{r results=hide}
## The following packages needed to be installed before running the following package-load function
...
packages <- c("devtools",# needed to install some packages
             ...
             #"metagMisc", #  lets you create lists of split phyloseq objects #Package not found
...
rm(packages,biocManager_packages) # we don't need this anymore so let's remove them from the environment
