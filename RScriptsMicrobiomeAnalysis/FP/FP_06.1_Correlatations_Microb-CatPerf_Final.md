...
load(file = "C:/Users/kreek001/OneDrive - Wageningen University & Research/Chapters/Experimental Chapter 3/RScripts/GitHub/TwelveAccessionExperiment/MicrobiomeAnalysis/Data/Phyloseq_objects/FP_DA_SummaryFiles/SummaryFiles_ASVLevel/Selction_DA_ASVs.RData")
...
``` r
Plot2 <- function(x, title, stats, xstep) {
  ggplot(data = FP_ps[FP_ps$OTU == x, ], aes(x = Abundance, y = Mean_Weight_Cat)) +
    geom_point() +
    geom_smooth(method = lm, se = FALSE) +
    # coord_cartesian(xlim = c(0, NA), ylim = c(0, NA)) +
...
``` r
# Print plots p value < 0.05 only negative correlations
wrap_plots(List_Graph_0.05_neg2_mod, ncol = 3) &
...
mapply(function(x)
  ggsave(plot = last_plot(), 
         ...
         units = "cm",
         dpi = 300),
  x = c("FP_SpearCorr_HM_0.05_neg3.svg", "FP_SpearCorr_HM_0.05_neg3.png"))
```
...
```
##                                                                                                                     FP_SpearCorr_HM_0.05_neg3.svg 
## "C:/Users/kreek001/OneDrive - Wageningen University & Research/Chapters/Experimental Chapter 3/Result/Final graphs/FP_SpearCorr_HM_0.05_neg3.svg" 
##                                                                                                                     FP_SpearCorr_HM_0.05_neg3.png 
## "C:/Users/kreek001/OneDrive - Wageningen University & Research/Chapters/Experimental Chapter 3/Result/Final graphs/FP_SpearCorr_HM_0.05_neg3.png"
```
